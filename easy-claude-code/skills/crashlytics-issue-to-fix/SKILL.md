...
1. `git remote get-url origin`이 성공하면 URL을 파싱해 `<owner>-<repo>` 형태로 변환. 예: `https://github.com/cyb9701/easy-claude-code.git` 또는 `git@github.com:cyb9701/easy-claude-code.git` → `cyb9701-easy-claude-code`
